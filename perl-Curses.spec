...
Source0  : https://cpan.metacpan.org/authors/id/G/GI/GIRAFFED/Curses-1.37.tar.gz
...
%prep
%setup -q -n Curses-1.37
cd %{_builddir}
tar xf %{_sourcedir}/libcurses-perl_1.36-1.debian.tar.xz
cd %{_builddir}/Curses-1.37
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Curses-1.37/deblicense/
...
cp %{_builddir}/Curses-1.37/Copying %{buildroot}/usr/share/package-licenses/perl-Curses/c0bf1a619a3a61a05da7ec8a9845e48fa4511c97
