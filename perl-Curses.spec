...
Source0  : https://cpan.metacpan.org/authors/id/G/GI/GIRAFFED/Curses-1.39.tar.gz
...
%prep
%setup -q -n Curses-1.39
cd %{_builddir}
tar xf %{_sourcedir}/libcurses-perl_1.36-1.debian.tar.xz
cd %{_builddir}/Curses-1.39
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Curses-1.39/deblicense/
