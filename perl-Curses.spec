...
Version  : 1.38
Release  : 26
URL      : https://cpan.metacpan.org/authors/id/G/GI/GIRAFFED/Curses-1.38.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/G/GI/GIRAFFED/Curses-1.38.tar.gz
...
%prep
%setup -q -n Curses-1.38
cd %{_builddir}
tar xf %{_sourcedir}/libcurses-perl_1.36-1.debian.tar.xz
cd %{_builddir}/Curses-1.38
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Curses-1.38/deblicense/
...
cp %{_builddir}/Curses-1.38/Copying %{buildroot}/usr/share/package-licenses/perl-Curses/c0bf1a619a3a61a05da7ec8a9845e48fa4511c97
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/Curses.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/Curses/Curses.so
